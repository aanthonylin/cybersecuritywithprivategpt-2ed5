[cybersecuritywithprivategpt-2ed5] Details
============================
...
.. list-table::
   ...
   * - **User Parameter**
     - **Chosen Value**
   * - solutionname
     - cybersecuritywithprivategpt-2ed5
   * - solutiontitle
     - TML Cybersecurity
   * - solutiondescription
...
.. list-table::
   ...
   * - identifier
     - Packet monitor
   * - jsoncriteria
     - uid=hostName,filter:allrecords~subtopics=hostName,hostName,hostName~values=pingStatus,inboundpackets,outboundpackets~identifiers=pingStatus,inboundpackets,outboundpackets~datetime=lastUpdated~msgid=~latlong=
...
.. list-table::
   ...
   * - partition
     - -1
   * - prompt
     - Do any of the values of inbound or outbound packets look abnormal?
   * - context
     - These are anomaly probabilities of suspicious data traffic. A high probability of over 0.80 is likely suspicious.
   * - jsonkeytogather
     - hyperprediction
   * - keyattribute
