...
Generated On: 2024-11-29 01:53:35 UTC
...
.. code-block::
   ...
   docker run -d -p 41429:41429 -p 35241:35241 -p 37275:37275 -p 8883:8883 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=41429 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=35241  \
          --env SOLUTIONVIPERVIZPORT=37275 \
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=41429, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=39411, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=45557, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=39853, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=34103, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=45737, HPDEHOST=127.0.1.1, HPDEPORT=43627, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=40739

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5263-cybersecuritywithprivategpt-2ed5,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2ed5, python-preprocess-2613-cybersecuritywithprivategpt-2ed5,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2ed5, python-ai-2061-cybersecuritywithprivategpt-2ed5,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2ed5, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
