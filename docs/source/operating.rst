...
.. code-block::
   ...
   docker run -d -p 45407:45407 -p 39793:39793 -p 57591:57591 -p 8883:8883 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=45407 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=39793  \
          --env SOLUTIONVIPERVIZPORT=57591 \
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=45407, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=43403, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=34659, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=46381, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=43903, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=33133, HPDEHOST=127.0.1.1, HPDEPORT=42043, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=35297

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-1346-cybersecuritywithprivategpt-2ed5,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2ed5, python-preprocess-5870-cybersecuritywithprivategpt-2ed5,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2ed5, python-ai-8432-cybersecuritywithprivategpt-2ed5,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2ed5, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
