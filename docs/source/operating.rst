[cybersecuritywithprivategpt-2ed5] Operating Details
====================================

Generated On: 2024-11-21 01:40:43 UTC
...
.. important::
   ...
   **not be valid if your [cybersecuritywithprivategpt-2ed5] container is NOT running**.

.. tip::
   You must have your [cybersecuritywithprivategpt-2ed5] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/aanthonylin/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=40673  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='aanthonylin'  \-\-env DOCKERUSERNAME='aanthonylin'  \-\-env MQTTUSERNAME='aanthonylin'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   aanthonylin/cybersecuritywithprivategpt-2ed5-amd64 (https://hub.docker.com/r/aanthonylin/cybersecuritywithprivategpt-2ed5-amd64)
...
.. important::
   docker run -d -p 47417:47417 -p 59617:59617 -p 34671:34671 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=cybersecuritywithprivategpt-2ed5 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2ed5 \-\-env GITUSERNAME=aanthonylin  \-\-env GITREPOURL=https://github.com/aanthonylin/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=47417  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=59617  \-\-env SOLUTIONVIPERVIZPORT=34671 \-\-env DOCKERUSERNAME='aanthonylin' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=40673 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='aanthonylin' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  aanthonylin/cybersecuritywithprivategpt-2ed5-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=34671
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=47417
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - aanthonylin/cybersecuritywithprivategpt-2ed5-amd64
...
It can be accessed by entering: http://localhost:59617
...
.. important::
   http://localhost:34671/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:34671/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:34671/<html file>
...
[cybersecuritywithprivategpt-2ed5] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/aanthonylin/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cybersecuritywithprivategpt-2ed5
...
.. important::
   https://cybersecuritywithprivategpt-2ed5.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2ed5
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=47417, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=39635, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=37085, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=35405, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=45075, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=44061, HPDEHOST=127.0.1.1, HPDEPORT=41025, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=45773
