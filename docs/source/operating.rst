...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/aanthonylin/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=40673  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='aanthonylin'  \-\-env DOCKERUSERNAME='aanthonylin'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='UU3UBTMZIP4QIHI6'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. code-block::
   ...
   docker run -d -p 60437:60437 -p 54071:54071 -p 60265:60265 -p 8883:8883 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=60437 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=54071  \
          --env SOLUTIONVIPERVIZPORT=60265 \
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=60437, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=36815, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=44685, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=39497, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=44765, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=42359, HPDEHOST=127.0.1.1, HPDEPORT=42553, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=41045

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6168-cybersecuritywithprivategpt-2ed5,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2ed5, python-preprocess-6834-cybersecuritywithprivategpt-2ed5,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2ed5, python-ai-1158-cybersecuritywithprivategpt-2ed5,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2ed5, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
