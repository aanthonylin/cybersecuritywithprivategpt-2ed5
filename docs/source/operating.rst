...
.. code-block::
   ...
   docker run -d -p 55853:55853 -p 36317:36317 -p 42307:42307 -p 8883:8883 \
          --env TSS=0 \
          --env SOLUTIONNAME=cybersecuritywithprivategpt-2ed5 \
          --env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2ed5 \
          --env GITUSERNAME=aanthonylin \
          --env GITREPOURL=https://github.com/aanthonylin/raspberrypi.git \
          --env SOLUTIONEXTERNALPORT=55853 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=36317  \
          --env SOLUTIONVIPERVIZPORT=42307 \
          --env DOCKERUSERNAME='aanthonylin' \
          --env CLIENTPORT=8883  \
          --env EXTERNALPORT=40673 \
          --env KAFKACLOUDUSERNAME='UU3UBTMZIP4QIHI6' \
          --env VIPERVIZPORT=9005 \
          --env MQTTUSERNAME='aanthonylin' \
          --env AIRFLOWPORT=9000  \
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=55853, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=42907, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=44459, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=46829, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=46197, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40595, HPDEHOST=127.0.1.1, HPDEPORT=36935, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=33403

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-4451-cybersecuritywithprivategpt-2ed5,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2ed5, python-preprocess-6619-cybersecuritywithprivategpt-2ed5,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2ed5, python-ai-6559-cybersecuritywithprivategpt-2ed5,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2ed5, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
